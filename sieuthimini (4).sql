...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2025 at 10:38 AM
...
(22, NULL, 1, 3, 'BANK', '2025-05-07 15:25:58', NULL, -1, 'FINISHED', 57000.00);
...
(3, 'KHANG', 'Nam', '2005-04-27', '123456789014', 'QUẢNG NGÃI KKK', '0762779665', 10000000.00, b'0', 'nv3.jpeg'),
...
(8, 'Võ Minh Tuấn', 'Nam', '1995-03-30', '567890123456', 'Cần Thơ', '0912345675', 9000000.00, b'1', 'nv8.png');
...
(1, 1, 1, 'camoi.png', 10000.00, 'Cá mòi', 'Cá mòi ngon, đậm đà', 'ACTIVE', 50),
(2, 1, 1, 'thithop.png', 20000.00, 'Thịt hộp', 'Thịt hộp siêu ngon', 'ACTIVE', 100),
(3, 1, 1, 'xucxich.png', 15000.00, 'Xúc xích', 'Xúc xích hihi', 'ACTIVE', 200),
(4, 1, 1, 'trungga.png', 25000.00, 'Trứng gà ', 'Trứng gà công nghiệp', 'ACTIVE', 80),
(5, 1, 1, 'mitom.png', 5000.00, 'Mì tôm', 'Mì ăn liền Hảo Hảo', 'ACTIVE', 500),
(6, 1, 2, 'dauan.png', 12000.00, 'Dầu ăn Neptune', 'Dầu ăn cao cấp', 'ACTIVE', 120),
(7, 1, 2, 'duong.png', 8000.00, 'Đường trắng', 'Đường tinh luyện', 'ACTIVE', 150),
(8, 1, 2, 'muoi.png', 18000.00, 'Muối', 'Muối sạch', 'ACTIVE', 100),
...
(11, 2, 3, 'cocacola.png', 10000.00, 'Coca Cola', 'Nước ngọt có ga', 'ACTIVE', 200),
(12, 2, 3, 'pepsi.png', 9000.00, 'Pepsi', 'Nước ngọt vị cola', 'ACTIVE', 180),
(13, 2, 3, 'c2.png', 12000.00, 'Trà xanh C2', 'Trà xanh giải nhiệt', 'ACTIVE', 160),
(14, 2, 3, 'revive.png', 15000.00, 'Revive', 'Nước bù khoáng', 'ACTIVE', 140),
(15, 2, 3, 'nuoccam.png', 20000.00, 'Nước cam Twister', 'Nước ép cam', 'ACTIVE', 130),
(16, 2, 4, 'banhoshi.png', 11000.00, 'Bánh oshi', 'Bánh ngon', 'ACTIVE', 170),
(17, 2, 4, 'banhmi.png', 25000.00, 'Bánh mỳ Kinh Đô', 'Bánh ngon', 'ACTIVE', 100),
(18, 2, 4, 'banhxep.png', 13000.00, 'Bánh xếp', 'Bánh ngon', 'ACTIVE', 120),
...
(2, 'Trần Ngọc Minh', '1988-06-22', 'Hải Dương', 150, '0987456124', '2023-02-01', '2025-02-01', 'nv1.jpg', 'ACTIVE'),
(3, 'Lê Thành Đạt', '1990-09-05', 'Đà Nẵng', 300, '0987456125', '2023-03-01', '2025-03-01', 'nv1.jpg', 'ACTIVE'),
(4, 'Phạm Quang Dũng', '1992-12-18', 'Bắc Ninh', 180, '0987456126', '2023-04-01', '2025-04-01', 'nv2.jpeg', 'ACTIVE'),
(5, 'Võ Hoài Nam', '1995-08-30', 'Cần Thơ', 250, '0987456127', '2023-05-01', '2025-05-01', 'nv1.jpg', 'ACTIVE'),
...
(11, 'ad', '2005-02-23', 'aaaa', 0, '9934567891', '2025-05-07', '2027-05-07', 'nv8.png', 'ACTIVE'),
(12, 'a', '2005-02-23', 'a', 0, '1112345644', '2025-05-07', '2027-05-07', 'nv8.png', 'ACTIVE'),
(13, 'lll', '2005-02-23', 'a', 0, '0002365419', '2025-05-07', '2027-05-07', 'nv7.jpg', 'ACTIVE');
